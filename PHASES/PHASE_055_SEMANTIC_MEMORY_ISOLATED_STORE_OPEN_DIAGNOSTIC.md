# PHASE_055 — Semantic-memory isolated store open diagnostic
...
Run semantic-memory runtime/retrieval tests and validation/gloss_live_semantic_memory_smoke_gate.py when live fixture is ready.
